...
<div id="guild_press_register_form">
    ...
    <form action="" name="f1" id="payment-form" method="post" >
        ...
        <div class="form-group">
            ...
            <font color="red">*</font>
            <input type="text" name="user_email" id="user_email" class="form-input" value="<?php echo $gp_data['user_email']; ?>">
        ...
        <div class="form-group">
            ...
            <input type="hidden" name="guild_press_action" value="user_register" class="form-input">
