<div class="form-box mb0">
    <form class="form-signin" name="form" action="<?php echo $this->wpfunc->esc_url($this->wpfunc->home_url($gp_data['wp_request'])); ?>" method="post" id="<?php echo SLUGNAME . '_calender_form'; ?>">
