<div class="container">
    ...
    <div class="content-box post-lists">
        ...
        <div class="post-box">
            ...
            <?php if ($gp_data['post_items'][0]['post_title'] !== '') : ?>
                ...
                <?php for ($i = 0; $i < count($gp_data['post_items']); $i++) : ?>
                    <?php if ($gp_data['post_items'][$i]['post_link'] !== '') : ?>
                        ...
                        <div class="col-xs-12 col-md-<?php echo $gp_data['col_num'][$i] ?> post-lists">
                            <a href="<?php echo $this->wpfunc->esc_url($gp_data['post_link']) ?>" title=""
                               class="posts-lists-link">
                                    ...
                                    <div class="single-post-content">
                                        <div class="center">
                                            ...
                                            <?php if (!empty($gp_data['post_thumb'])) : ?>
                                                ...
                                                <img class="single-post-thumbnail"
                                                     src="<?php echo $this->wpfunc->esc_url($gp_data['post_thumb']); ?>"
                                                     style="width: 100%;">

                                            <?php else : ?>

                                                <img class="single-post-thumbnail"
                                                     src="<?php echo $gp_data['no_image']; ?>" alt=""
                                                     style="width: 100%;">
                                            <?php endif; ?>
